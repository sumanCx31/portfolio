...
export default function Hero({ fadeUp, staggerContainer }: HeroProps): React.JSX.Element {
  ...
  return (
    <section id="about" className="relative min-h-screen flex items-center justify-center bg-[#0a0a0a] text-neutral-100 font-sans antialiased py-32 selection:bg-neutral-200 selection:text-neutral-900 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl w-full px-6 mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="flex items-center gap-3 text-xs tracking-widest uppercase text-neutral-400 font-mono">
            <span className="w-8 h-[1px] bg-neutral-700" />
            <span className="flex items-center gap-1.5">
              <Sparkles className="w-3 h-3 text-neutral-400" /> AI/ML Engineer & Full-Stack Developer
            </span>
          </motion.div>
          ...
          <div className="space-y-3">
            ...
            <motion.p variants={fadeUp} className="text-neutral-400 text-lg sm:text-xl font-light tracking-wide pt-1">
              Building intelligent applications and data-driven solutions.
            </motion.p>
          </div>

          {/* Core Biography Container */}
          <motion.div variants={fadeUp} className="text-neutral-400 text-sm sm:text-base leading-relaxed max-w-xl font-normal border-l border-neutral-800 pl-4 my-1">
             <Bio />
          </motion.div>

          {/* Refined Actions Group */}
          <motion.div variants={fadeUp} className="flex flex-wrap items-center gap-3.5 pt-3 w-full">
            <motion.a 
              whileHover={{ y: -1 }}
              whileTap={{ scale: 0.98 }}
              href="#contact" 
